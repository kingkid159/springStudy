...
import basic_4.DuplicateMemberException;
import basic_4.MemberInfoPrinter;
import basic_4.MemberListPrinter;
import basic_4.MemberNotFoundException;
import basic_4.MemberRegisterService;
import basic_4.RegisterRequest;
import basic_4.VersionPrinter;
import basic_4.WrongIdPasswordException;
import basic_4.assembler.Assembler;
import basic_4.config.AppCtx;
...
public class MainForSpring {
	...
	private static void processNewCommand(String[] arg) {
		...
		MemberRegisterService regSvc = 
				//Component에 값을 주지 않았기 때문에 클래스의 첫 글자를 소문자로 바꾼 클래스 명을 빈으로 사용한다
